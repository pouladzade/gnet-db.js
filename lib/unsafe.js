 ...
 * @param {string} publicKey - The public key of the validator
 * @param {*} context - an object containing information for the validator.
 * @param {module:rpc/rpc~methodCallback} callback - The callback function.
 */
Unsafe.prototype.bond = function (privKey, toAddress, amount,fee,publicKey, context, callback) {
  if (!this._validator.validate(context)) {
    callback(new Error('Validation failed'))
  }
  if (!util.isPrivKey(privKey)) {
 ...
 * @param {module:rpc/rpc~methodCallback} callback - The callback function.
 */
Unsafe.prototype.unbond = function (privKey, toAddress, amount,fee, context, callback) {
  if (!this._validator.validate(context)) {
    callback(new Error('Validation failed'))
  }
  if (!util.isPrivKey(privKey)) {
