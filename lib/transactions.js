...
/**
 * Bond to the account at the given address.
 *
 * Note: This requires a private key to be sent to the blockchain client.
 *
 * @param {string} privKey - The private key that will be used to sign.
 * @param {string} toAddress - The target account address.
 * @param {number} amount - The amount to bond.
 * @param {number} fee - The fee to bond.
 * @param {*} context - an object containing information for the validator.
 * @param {string} pubKey - The public key of the validator
 * @param {module:rpc/rpc~methodCallback} callback - The callback function.
 */
Transactions.prototype.bond = function (privKey, toAddress, amount,fee,pubKey, context,
  callback) {
  this._unsafe.bond(privKey, toAddress, amount,fee, pubKey,context, callback)
}


/**
 * UnBond to the account at the given address.
 *
 * Note: This requires a private key to be sent to the blockchain client.
 *
 * @param {string} privKey - The private key that will be used to sign.
 * @param {string} toAddress - The target account address.
 * @param {number} amount - The amount to unbond.
 * @param {number} fee - The fee to unbond.
 * @param {*} context - an object containing information for the validator. 
 * @param {module:rpc/rpc~methodCallback} callback - The callback function.
 */
Transactions.prototype.unbond = function (privKey, toAddress, amount,fee, context,
  callback) {
  this._unsafe.unbond(privKey, toAddress, amount,fee,context, callback)
}
